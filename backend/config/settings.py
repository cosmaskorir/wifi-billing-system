...
# SECURITY WARNING: We force this to True for local development to prevent crashes.
DEBUG = True
...
INSTALLED_APPS = [
    ...
    "unfold",
    "unfold.contrib.filters",  # Optional: Adds modern filters
    "unfold.contrib.forms",    # Optional: Adds modern forms
...
# Defaulting to SQLite to ensure the server starts without PostgreSQL errors.
DATABASES = {
    'default': {
...
# Point to our custom User model in users/models.py
